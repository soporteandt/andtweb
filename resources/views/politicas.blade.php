...
<head>
    ...
    <title>Política de Privacidad | ANDT Digital Solutions</title>
    <link rel="stylesheet" href="css/styles.css">
    <meta name="description" content="Política de privacidad de ANDT Digital Solutions. Explicamos cómo protegemos y utilizamos tu información personal.">
</head>
<body>
    <header>
        <div class="container">
            <h1 class="logo">Política de Privacidad</h1>
            <nav>
                <ul>
    ...
    <footer>
        <div class="container" style="text-align: center; border-top: 1px solid #ccc; padding-top: 10px;">
